...
export default function Logo({ className, labelClassName, linkTo = "/", light = false }: LogoProps) {
  return (
    <Link to={linkTo} className={cn("inline-flex items-center gap-2.5 group", className)}>
      <svg
        ...
        aria-hidden="true"
      >
        <rect width="34" height="34" rx="9" fill="#40916C" />
        <path
        ...
        <circle cx="13" cy="22" r="2" fill="#B7E4C7" />
        <circle cx="21" cy="22" r="2" fill="#B7E4C7" />
      </svg>
      <span
        className={cn(
