  ...
  return (
    ...
    >
      <Card id="camera" variant="elevated" className="flex flex-col gap-5">
        ...
        >
          ...
          <AnimatePresence mode="wait">
            ...
            {isActive && !cameraError && (
              ...
              >
                {/* Scanning line */}
                <motion.div
                  className="absolute left-0 right-0 h-px bg-mint-400/40"
                  style={{ top: "20%" }}
          ...
          {isActive && (
            <div className="absolute bottom-3 left-3">
              <div
                className={`flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold backdrop-blur-sm ${
                  micEnabled
        ...
        {/* Recording controls — only when camera is on */}
        {isActive && (
          <motion.div
