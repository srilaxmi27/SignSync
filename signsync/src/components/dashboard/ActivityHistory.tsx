  ...
  return (
    <div className="relative flex h-12 w-12 shrink-0 items-center justify-center">
      <svg className="-rotate-90" width="48" height="48">
        <circle cx="24" cy="24" r={r} fill="none" stroke="currentColor" strokeWidth="3" className="text-ink-900/8" />
        <motion.circle
          cx="24" cy="24" r={r}
          fill="none"
          stroke="currentColor"
    ...
    >
      <Card id="activity" variant="elevated" className="flex flex-col gap-5">
        <div className="flex items-center justify-between">
          ...
          <button className="text-sm font-semibold text-signal-600 hover:text-signal-700 transition-colors">
            View all
          </button>
        </div>
